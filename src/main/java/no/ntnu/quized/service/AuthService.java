package no.ntnu.quized.service;
...
import no.ntnu.quized.model.User.Role;
import no.ntnu.quized.model.User.User;
import no.ntnu.quized.repository.UserRepository;
import no.ntnu.quized.security.JwtService;
import no.ntnu.quized.service.registration.EmailVerificationTokenService;
import no.ntnu.quized.service.registration.MailService;
